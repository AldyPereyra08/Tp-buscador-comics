...
const restUrl = "ts=1&apikey=dab43c80b55253968a79a053580769af&hash=adfe4d84c4c26526f2bda6321c6bb7ed"
const apiKey = "dab43c80b55253968a79a053580769af"
//const apiKey = "dab43c80b55253968a79a053580769af"
//const hash = "0b0bd541e067653704d4a040b21a0c9a"

//mia pero al reves"68de33a94448443656160ea243d5ce53"

//mia "0b0bd541e067653704d4a040b21a0c9a"

//la que funciona "05db1849d82fefc677c13a9900c87b4f"
...
//hash vale = "6FA8B6F40756AB1891F5ADAD1057A0F1";
...
const mostrarResultados = (tipo = "comics", orden = "title", inputBusqueda = "") => {
    ...
    //&orderBy=${orden}${valorInput}&offset=${paginaActual * resultadosPorPagina}
    //&orderBy=${orden}${valorInput}&offset=${paginaActual * resultadosPorPagina}
    fetch(`${urlBase}${tipo}?${restUrl}&orderBy=${orden}${valorInput}&offset=${paginaActual * resultadosPorPagina}`)
    .then(res => res.json())
    .then(data => {
